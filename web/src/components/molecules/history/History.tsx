    ...
    <HistoryContainer id="history">
      ...
      <>
        <HistoryContent>
          ...
          <HistoryImage className="firstImage" src={LourdesImg} alt="Lourdes Santiago segurando filhotes de cães" />
        </HistoryContent>
        {windowWidth < 1000 && <HistoryText>{text[1]}</HistoryText>}
        {windowWidth < 1200 && <HistoryText>{text[2]}</HistoryText>}
        ...
        <HistoryContent>
          ...
          <HistoryImage src={AnaLourdesImg} alt="Citação de Ana Elizabeth Janini" />
        </HistoryContent>
      </>
      <HistoryText className="withoutMargin">
        <HistoryBoldText>Lourdes Santiago, no jornal A Cidade, em 06/10/2001</HistoryBoldText>
        {text[5]}
      </HistoryText>
    </HistoryContainer>
  );
